...
class WebhookEndpointController extends Controller
{
    ...
    public function deliveries(Request $request, WebhookEndpoint $webhookEndpoint): Response
    {
        ...
        // Projected explicitly rather than serialising the models: $hidden on
        // WebhookDelivery already withholds response_body, but an explicit
        // allowlist means a future column cannot leak by simply existing.
