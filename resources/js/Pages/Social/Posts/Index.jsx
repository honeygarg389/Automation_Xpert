...
const NETWORKS = ['facebook', 'instagram', 'linkedin', 'twitter', 'youtube'];
const NETWORK_LABELS = { facebook: 'Facebook', instagram: 'Instagram', linkedin: 'LinkedIn', twitter: 'X (Twitter)', youtube: 'YouTube' };
